...
class b_Max3m_정수최댓값구하기 {
	// a, b, c의 최댓값을 구하여 반환합니다.
	static int max3(int a, int b, int c) {//int a, int b, int c 이것들을 매개변수,parameter라 함
		int max = a;						// 최댓값
		if (b > max) 
			max = b;
		if (c > max) 
	...
	public static void main(String[] args) {
		System.out.println("max3(3,2,1) = " + max3(3, 2, 1));//매개변수의값 3,2,1을 실인수라함 actual argument
		// [A] a＞b＞c
